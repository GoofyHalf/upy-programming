...
if rol == 'alumno':
    ...
    while not actualizado:
        try:
            ...
            # Validar que el alumno y la materia existan antes de escribir
            ...
            print("La calificación debe ser un número. Intente de nuevo.")
        except KeyError as error:
            if str(error) == "'alumno'":
                print("Ese alumno no existe. Intente de nuevo.")
            else:
                print("Esa materia no existe. Intente de nuevo.")
